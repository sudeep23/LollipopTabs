package com.sudeep23.lollipoptabs.fixedtab;
/*
 ...
 */
public class FixedTabLayout extends HorizontalScrollView {
    ...
    private final FixedTabStrip mTabStrip;
    ...
    public FixedTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabStrip = new FixedTabStrip(context);
    ...
    /**
     * Set the {@link android.support.v4.view.ViewPager.OnPageChangeListener}. When using {@link com.sudeep23.lollipoptabs.fixedtab.FixedTabLayout} you are
    ...
    /**
     *Set the total number of tabs so that it can optimize the view
     */
